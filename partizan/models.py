...
class FullOrder(models.Model):
    ...
    phone = models.CharField(max_length=20, verbose_name="Телефон")
    email = models.EmailField(verbose_name="Email", blank=True)  # Добавьте эту строку
    ...
    selected_date = models.DateField(verbose_name="Выбранная дата", null=True)
    selected_time = models.CharField(max_length=20, verbose_name="Выбранное время", blank=True)
    ...
    def __str__(self):
        return f"{self.full_name} - {self.holiday.title} - {self.selected_date}"
